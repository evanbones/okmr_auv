...
class MotorCortexNode : public rclcpp::Node
{
    public:
        ...
        : Node("motor_cortex_node"){ 
            ...
            goal_pose_subscription = this->create_subscription<okmr_msgs::msg::GoalPose>("/current_goal_pose", 10, std::bind(&MotorCortexNode::goal_pose_callback, this, _1));
            ...
            pidPublisherMap.insert(std::pair{"pitch", this->create_publisher<okmr_msgs::msg::SensorReading>("/PID/pitch/target", 10)});
            pidPublisherMap.insert(std::pair{"roll", this->create_publisher<okmr_msgs::msg::SensorReading>("/PID/roll/target", 10)});
            pidPublisherMap.insert(std::pair{"zero_translation", this->create_publisher<okmr_msgs::msg::SensorReading>("/PID/translation/target", 10)});
            pidPublisherMap.insert(std::pair{"x_translation", this->create_publisher<okmr_msgs::msg::SensorReading>("/PID/x_translation/actual", 10)});
            pidPublisherMap.insert(std::pair{"y_translation", this->create_publisher<okmr_msgs::msg::SensorReading>("/PID/y_translation/actual", 10)});
            pidPublisherMap.insert(std::pair{"z_translation", this->create_publisher<okmr_msgs::msg::SensorReading>("/PID/z_translation/actual", 10)});
    ...
    private:
        ...
        void updateSetPoints(){
            ...
            auto message = okmr_msgs::msg::Status();
        }
        okmr_msgs::msg::GoalPose currentGoalPoseMsg; 
