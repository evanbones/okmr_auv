...
{
    Eigen::BDCSVD<Eigen::MatrixXf> svd(A, Eigen::ComputeThinU | Eigen::ComputeThinV); // supposedly deprecated in Eigen 3.4.90
    //build errors when passing options in template args, even though thats the recommended way to do it?
