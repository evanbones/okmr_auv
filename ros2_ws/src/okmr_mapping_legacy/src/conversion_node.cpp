...
void conversion_callback (const shared_ptr<okmr_msgs::srv::Vg2pc::Request> request,
                          shared_ptr<okmr_msgs::srv::Vg2pc::Response> response) {
    ...
    auto voxel_lambda = [&ofile, &point_num, &point_size] (const voxelData& data,
...
int main (int argc, char** argv) {
    ...
    rclcpp::Service<okmr_msgs::srv::Vg2pc>::SharedPtr service =
        node->create_service<okmr_msgs::srv::Vg2pc> ("vg2pc", &conversion_callback);
